	...
	<div class="col-lg-12">
		<div class="panel panel-defualt">
			...
			<div class="panel-body">
				...
				<form role="form" action="/board/modify_N" method="post" id="mform">
...
$(document).ready(function(){
	...
	$("button").on("click", function(e){
		...
		if(operation === "remove"){
			formObj.attr("action", "/board/remove_N"); //form에 action 경로 /board/remove로 변경
		}else if(operation === "list"){
			formObj.attr("action", "/board/list_N").attr("method", "get"); //form에 action 경로 /board/list, method get으로 변경

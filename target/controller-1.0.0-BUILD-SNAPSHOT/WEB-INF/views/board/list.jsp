...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">게시판 목록 
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<c:forEach items="${list}" var="board">
						<tr>
							...
							<td>
								<a class='move' href='<c:out value="${board.brd_id}"/>'>
									<c:out value="${board.brd_sub }" />
								<b>[<c:out value="${board.cmt_cnt}"/>]</b>
								</a>
							</td>
	...
	<div class="row"> 
		<div class="col-lg-12">
			<form id="searchForm" action="/board/list" method="get">
				...
				<select name="type">
					<option value="" <c:out value="${pageMaker.cri.type == null? 'selected':'' }"/>>종류</option>
